...
- **Rotate/move/keep/reverse page range**, **reset rotation range**, **crop range**, **crop/expand/shrink odd/even**, **insert blank pages**, **blank between pages**, **duplicate range to end/before**, **duplicate page/odd/even**, **rotate odd/even** (CW/CCW/180/reset), **rotate all 180°**, **keep/delete odd/even**, **flatten odd/even**, **sort by rotation**, **delete every Nth**, **move range to start/end**, **reverse odd/even**, **move odd/even to start**, **extract odd/even**, **split at page**, **shrink margins**
