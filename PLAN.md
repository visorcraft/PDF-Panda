...
| Highlight | Click-to-draw highlights, persisted + read back; H toggles mode; Escape exits highlight mode or dismisses modals | `get_annotations_returns_empty_without_highlights`, `highlight_add_and_read_back` |
