...
mod tests {
    ...
    fn extract_odd_pages_in_range_rejects_invalid_range() {
        ...
        let err =
            extract_odd_pages_in_range(path.clone(), 5, 10, output_path.to_string_lossy().into_owned()).unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn extract_even_pages_in_range_rejects_invalid_range() {
        ...
        let output_path = tmp("extract_out.pdf");
        let err =
            extract_even_pages_in_range(path.clone(), 5, 10, output_path.to_string_lossy().into_owned()).unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_odd_pages_in_range_as_pdf_rejects_invalid_range() {
        ...
        let err = export_odd_pages_in_range_as_pdf(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
            .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_even_pages_in_range_as_pdf_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err = export_even_pages_in_range_as_pdf(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
            .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_even_pages_in_range_jpeg_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err = export_even_pages_in_range_jpeg(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
            .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_even_pages_in_range_webp_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err = export_even_pages_in_range_webp(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
            .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_even_pages_in_range_tiff_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err = export_even_pages_in_range_tiff(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
            .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_odd_pages_ico_rejects_missing_file() {
        ...
        let err =
            export_odd_pages_ico(missing.to_string_lossy().into_owned(), output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("File not found"));
    }
    ...
    fn export_even_pages_ico_rejects_missing_file() {
        ...
        let err =
            export_even_pages_ico(missing.to_string_lossy().into_owned(), output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("File not found"));
    }
    ...
    fn extract_range_local_even_pages_rejects_invalid_range() {
        ...
        let output_path = tmp("extract_out.pdf");
        let err = extract_range_local_even_pages(path.clone(), 5, 10, output_path.to_string_lossy().into_owned())
            .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_range_local_odd_pages_png_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err = export_range_local_odd_pages_png(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
            .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_range_local_even_pages_png_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err = export_range_local_even_pages_png(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
            .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_range_local_odd_pages_jpeg_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err = export_range_local_odd_pages_jpeg(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
            .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_range_local_even_pages_jpeg_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err = export_range_local_even_pages_jpeg(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
            .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_range_local_odd_pages_webp_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err = export_range_local_odd_pages_webp(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
            .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_range_local_even_pages_webp_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err = export_range_local_even_pages_webp(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
            .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_range_local_odd_pages_bmp_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err = export_range_local_odd_pages_bmp(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
            .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_range_local_even_pages_bmp_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err = export_range_local_even_pages_bmp(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
            .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_range_local_odd_pages_tiff_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err = export_range_local_odd_pages_tiff(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
            .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_range_local_even_pages_tiff_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err = export_range_local_even_pages_tiff(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
            .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_range_local_odd_pages_gif_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err = export_range_local_odd_pages_gif(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
            .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_range_local_even_pages_gif_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err = export_range_local_even_pages_gif(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
            .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_range_local_odd_pages_ppm_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err = export_range_local_odd_pages_ppm(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
            .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_range_local_even_pages_ppm_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err = export_range_local_even_pages_ppm(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
            .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_range_local_odd_pages_tga_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err = export_range_local_odd_pages_tga(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
            .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_range_local_even_pages_tga_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err = export_range_local_even_pages_tga(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
            .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod3_0_pages_in_range_mod3_as_pdf_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod3_0_pages_in_range_mod3_as_pdf(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod3_1_pages_in_range_mod3_as_pdf_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod3_1_pages_in_range_mod3_as_pdf(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod3_2_pages_in_range_mod3_as_pdf_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod3_2_pages_in_range_mod3_as_pdf(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod3_0_pages_in_range_mod3_jpeg_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod3_0_pages_in_range_mod3_jpeg(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_second_half_pages_in_range_webp_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_second_half_pages_in_range_webp(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_second_half_pages_in_range_tiff_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_second_half_pages_in_range_tiff(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod4_0_pages_in_range_mod4_as_pdf_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod4_0_pages_in_range_mod4_as_pdf(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod4_1_pages_in_range_mod4_as_pdf_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod4_1_pages_in_range_mod4_as_pdf(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod4_2_pages_in_range_mod4_as_pdf_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod4_2_pages_in_range_mod4_as_pdf(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod4_3_pages_in_range_mod4_as_pdf_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod4_3_pages_in_range_mod4_as_pdf(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod4_0_pages_in_range_mod4_jpeg_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod4_0_pages_in_range_mod4_jpeg(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod4_1_pages_in_range_mod4_jpeg_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod4_1_pages_in_range_mod4_jpeg(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod4_2_pages_in_range_mod4_jpeg_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod4_2_pages_in_range_mod4_jpeg(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod4_3_pages_in_range_mod4_jpeg_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod4_3_pages_in_range_mod4_jpeg(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod4_0_pages_in_range_mod4_webp_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod4_0_pages_in_range_mod4_webp(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod4_1_pages_in_range_mod4_webp_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod4_1_pages_in_range_mod4_webp(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod4_2_pages_in_range_mod4_webp_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod4_2_pages_in_range_mod4_webp(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod4_3_pages_in_range_mod4_webp_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod4_3_pages_in_range_mod4_webp(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod4_0_pages_in_range_mod4_tiff_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod4_0_pages_in_range_mod4_tiff(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod4_1_pages_in_range_mod4_tiff_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod4_1_pages_in_range_mod4_tiff(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod4_2_pages_in_range_mod4_tiff_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod4_2_pages_in_range_mod4_tiff(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod4_3_pages_in_range_mod4_tiff_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod4_3_pages_in_range_mod4_tiff(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod5_0_pages_in_range_mod5_as_pdf_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod5_0_pages_in_range_mod5_as_pdf(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod5_1_pages_in_range_mod5_as_pdf_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod5_1_pages_in_range_mod5_as_pdf(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod5_2_pages_in_range_mod5_as_pdf_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod5_2_pages_in_range_mod5_as_pdf(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod5_3_pages_in_range_mod5_as_pdf_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod5_3_pages_in_range_mod5_as_pdf(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod5_4_pages_in_range_mod5_as_pdf_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod5_4_pages_in_range_mod5_as_pdf(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod5_0_pages_in_range_mod5_jpeg_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod5_0_pages_in_range_mod5_jpeg(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod5_1_pages_in_range_mod5_jpeg_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod5_1_pages_in_range_mod5_jpeg(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod5_2_pages_in_range_mod5_jpeg_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod5_2_pages_in_range_mod5_jpeg(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod5_3_pages_in_range_mod5_jpeg_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod5_3_pages_in_range_mod5_jpeg(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod5_4_pages_in_range_mod5_jpeg_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod5_4_pages_in_range_mod5_jpeg(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod5_0_pages_in_range_mod5_webp_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod5_0_pages_in_range_mod5_webp(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod5_1_pages_in_range_mod5_webp_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod5_1_pages_in_range_mod5_webp(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod5_2_pages_in_range_mod5_webp_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod5_2_pages_in_range_mod5_webp(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod5_3_pages_in_range_mod5_webp_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod5_3_pages_in_range_mod5_webp(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod5_4_pages_in_range_mod5_webp_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod5_4_pages_in_range_mod5_webp(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod5_0_pages_in_range_mod5_tiff_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod5_0_pages_in_range_mod5_tiff(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod5_1_pages_in_range_mod5_tiff_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod5_1_pages_in_range_mod5_tiff(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod5_2_pages_in_range_mod5_tiff_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod5_2_pages_in_range_mod5_tiff(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod5_3_pages_in_range_mod5_tiff_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod5_3_pages_in_range_mod5_tiff(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod5_4_pages_in_range_mod5_tiff_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod5_4_pages_in_range_mod5_tiff(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod6_0_pages_in_range_mod6_as_pdf_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod6_0_pages_in_range_mod6_as_pdf(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod6_1_pages_in_range_mod6_as_pdf_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod6_1_pages_in_range_mod6_as_pdf(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod6_2_pages_in_range_mod6_as_pdf_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod6_2_pages_in_range_mod6_as_pdf(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod6_3_pages_in_range_mod6_as_pdf_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod6_3_pages_in_range_mod6_as_pdf(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod6_4_pages_in_range_mod6_as_pdf_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod6_4_pages_in_range_mod6_as_pdf(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod6_5_pages_in_range_mod6_as_pdf_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod6_5_pages_in_range_mod6_as_pdf(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod6_0_pages_in_range_mod6_jpeg_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod6_0_pages_in_range_mod6_jpeg(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod6_1_pages_in_range_mod6_jpeg_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod6_1_pages_in_range_mod6_jpeg(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod6_2_pages_in_range_mod6_jpeg_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod6_2_pages_in_range_mod6_jpeg(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod6_3_pages_in_range_mod6_jpeg_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod6_3_pages_in_range_mod6_jpeg(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod6_4_pages_in_range_mod6_jpeg_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod6_4_pages_in_range_mod6_jpeg(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod6_5_pages_in_range_mod6_jpeg_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod6_5_pages_in_range_mod6_jpeg(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod6_0_pages_in_range_mod6_webp_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod6_0_pages_in_range_mod6_webp(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod6_1_pages_in_range_mod6_webp_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod6_1_pages_in_range_mod6_webp(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod6_2_pages_in_range_mod6_webp_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod6_2_pages_in_range_mod6_webp(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod6_3_pages_in_range_mod6_webp_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod6_3_pages_in_range_mod6_webp(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod6_4_pages_in_range_mod6_webp_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod6_4_pages_in_range_mod6_webp(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod6_5_pages_in_range_mod6_webp_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod6_5_pages_in_range_mod6_webp(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod6_0_pages_in_range_mod6_tiff_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod6_0_pages_in_range_mod6_tiff(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod6_1_pages_in_range_mod6_tiff_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod6_1_pages_in_range_mod6_tiff(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod6_2_pages_in_range_mod6_tiff_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod6_2_pages_in_range_mod6_tiff(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod6_3_pages_in_range_mod6_tiff_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod6_3_pages_in_range_mod6_tiff(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod6_4_pages_in_range_mod6_tiff_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod6_4_pages_in_range_mod6_tiff(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_mod6_5_pages_in_range_mod6_tiff_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_mod6_5_pages_in_range_mod6_tiff(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_first_third_pages_in_range_as_pdf_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_first_third_pages_in_range_as_pdf(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_second_third_pages_in_range_as_pdf_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_second_third_pages_in_range_as_pdf(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_third_third_pages_in_range_as_pdf_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_third_third_pages_in_range_as_pdf(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_second_third_pages_in_range_png_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_second_third_pages_in_range_png(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_first_third_pages_in_range_jpeg_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_first_third_pages_in_range_jpeg(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_second_third_pages_in_range_jpeg_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_second_third_pages_in_range_jpeg(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_third_third_pages_in_range_jpeg_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_third_third_pages_in_range_jpeg(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_first_third_pages_in_range_webp_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_first_third_pages_in_range_webp(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_second_third_pages_in_range_webp_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_second_third_pages_in_range_webp(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_third_third_pages_in_range_webp_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_third_third_pages_in_range_webp(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_second_third_pages_in_range_bmp_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_second_third_pages_in_range_bmp(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_first_third_pages_in_range_tiff_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_first_third_pages_in_range_tiff(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_second_third_pages_in_range_tiff_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_second_third_pages_in_range_tiff(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_third_third_pages_in_range_tiff_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_third_third_pages_in_range_tiff(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_second_third_pages_in_range_gif_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_second_third_pages_in_range_gif(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_second_third_pages_in_range_ppm_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_second_third_pages_in_range_ppm(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_second_third_pages_in_range_tga_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_second_third_pages_in_range_tga(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
    ...
    fn export_second_third_pages_in_range_ico_rejects_invalid_range() {
        ...
        let output_dir = tmp("export_dir");
        let err =
            export_second_third_pages_in_range_ico(path.clone(), 5, 10, output_dir.to_string_lossy().into_owned())
                .unwrap_err();
        assert!(err.contains("Invalid page range"));
        let _ = std::fs::remove_file(&path);
    }
