...
- [ ] Delete / duplicate / dup. before / dup. odd+even / dup. odd+even before / dup. range (before+to end) / dup. all / dup. to end / rotate / rot. range (CW/CCW/180/reset) / rot. odd+even (CW/CCW/180/reset) / rotate all 180° / CCW / reset rot. / rotate all / all CCW / reverse / rev. range / rev. odd+even / odd→start / even→start / odd→end / even→end / blank before+after / blank pages / blank between / move up+down / move range (to start+end) / keep range / keep odd+even / del odd+even / swap / replace / interleave / prepend / odd-even split / split at / split N / sort ↑↓ / odd+even sort ↑↓ / rot sort ↑↓ / odd+even rot sort ↑↓ / delete range / delete nth / reorder / insert / image page / merge / extract / extract odd+even / export page PDF / export pages PDF / split
- [ ] Export PNG/JPEG/WebP/BMP/TIFF/GIF/PPM/TGA/ICO, page dimensions, page numbers, page header+footer, page size presets, border, expand+shrink margins (incl. odd+even), crop range / crop odd+even, watermark, crop (single/all/clear all/odd+even), flatten annotations, flatten all/odd/even
