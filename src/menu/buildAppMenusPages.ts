...
export function buildPagesMenu(ctx: AppMenuContext): MenuRoot {
  ...
  return {
    ...
    items: [
      sub('Rotate', [
        act('rot-cw', 'Current page 90° clockwise', ctx.handleRotatePage, { shortcutCommandId: 'rotate-page' }),
      ...
      sub('Duplicate', [
        act('dup', 'Duplicate current page', ctx.handleDuplicatePage, { shortcutCommandId: 'duplicate-page' }),
      ...
      sub('Move & order', [
        ...
        sep(),
        act('reverse', 'Reverse all pages', ctx.handleReversePages, { shortcutCommandId: 'reverse-pages' }),
      ...
      sub('Insert', [
        act('blank-after', 'Blank page after current', ctx.handleAddBlankPage, { shortcutCommandId: 'blank-page-after' }),
        ...
        sep(),
        act('insert-pdf', 'Pages from another PDF…', ctx.openInsertModal, { shortcutCommandId: 'insert-pdf' }),
        act('image-page', 'Image as new page…', ctx.openInsertImagePageModal),
      ]),
      sub('Delete', [
        act('delete', 'Delete current page', ctx.openDeleteModal, { shortcutCommandId: 'delete-page', disabled: !del, danger: true }),
      ...
      sub('Split & extract', [
        act('split', 'Split into parts…', ctx.openSplitModal, { shortcutCommandId: 'split-pdf' }),
        act('split-at', 'Split at page…', ctx.openSplitAtModal, { disabled: !mp }),
        act('split-n', 'Split every N pages…', ctx.openSplitEveryModal),
        sep(),
        act('extract', 'Extract pages…', ctx.openExtractModal, { shortcutCommandId: 'extract-pages' }),
      ...
      sub('Combine', [
        act('merge', 'Merge PDF (append)…', ctx.openMergeModal, { shortcutCommandId: 'merge-pdf' }),
