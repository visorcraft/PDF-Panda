...
export function buildAppMenus(ctx: AppMenuContext): AppMenus {
  ...
  const pagesMenu: MenuRoot = {
    ...
    items: [
      ...
      sub('Sort', [
        act('sort-size-up', 'By size (smallest first)', () => ctx.handleSortPagesBySize(false)),
        act('sort-size-down', 'By size (largest first)', () => ctx.handleSortPagesBySize(true)),
        act('sort-rot-up', 'By rotation (0° first)', () => ctx.handleSortPagesByRotation(false)),
        act('sort-rot-down', 'By rotation (270° first)', () => ctx.handleSortPagesByRotation(true)),
        sep(),
        act('sort-odd-size-up', 'Odd pages by size ↑', () => ctx.handleSortOddPagesBySize(false), { disabled: !mp }),
        act('sort-odd-size-down', 'Odd pages by size ↓', () => ctx.handleSortOddPagesBySize(true), { disabled: !mp }),
        act('sort-even-size-up', 'Even pages by size ↑', () => ctx.handleSortEvenPagesBySize(false), { disabled: !mp }),
        act('sort-even-size-down', 'Even pages by size ↓', () => ctx.handleSortEvenPagesBySize(true), { disabled: !mp }),
        sep(),
        act('sort-odd-rot-up', 'Odd pages by rotation ↑', () => ctx.handleSortOddPagesByRotation(false), { disabled: !mp }),
        act('sort-odd-rot-down', 'Odd pages by rotation ↓', () => ctx.handleSortOddPagesByRotation(true), { disabled: !mp }),
        act('sort-even-rot-up', 'Even pages by rotation ↑', () => ctx.handleSortEvenPagesByRotation(false), { disabled: !mp }),
        act('sort-even-rot-down', 'Even pages by rotation ↓', () => ctx.handleSortEvenPagesByRotation(true), { disabled: !mp }),
      ]),
      sep(),
